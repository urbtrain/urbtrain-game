...
export class Runner {
  ...
  private elapsed = 0;
  public constructor() {
    const skin = this.mat("skin", "#b97951"); const shirt = this.mat("shirt", CONFIG.colors.black); const yellow = this.mat("yellow", CONFIG.colors.yellow); const shoe = this.mat("shoe", CONFIG.colors.white);
    ...
    const head = MeshBuilder.CreateSphere("runner-head", { diameter: 0.9, segments: 12 }); head.parent = this.root; head.position.y = 3.45; head.material = skin;
